...
Printer.prototype.size = function (width, height) {
  height = height === 2 ? (1 << 4 ) : 0 //double height:0001
  width = width === 2 ? (2 << 4 ) : 0 //double width: 0010

  this._buffer.write('\x1b\x21')
  var mode = height | width
  this._buffer.writeUInt8(mode)
  return this;
};
